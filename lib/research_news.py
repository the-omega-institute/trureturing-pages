...
def render_news(output, snapshot, shell):
    ...
    body = f'''<main class="site-main research-news"><header class="news-heading"><p class="eyebrow">THE OMEGA INSTITUTE</p><h1>Research</h1><p class="news-lede">Mathematical discoveries, formal proofs, and the questions that come next.</p><nav class="news-links" aria-label="Research destinations"><a href="conjectures.html#next-questions">Our next questions <i data-lucide="arrow-up-right"></i></a><a href="atlas.html#mode=frontier">Mathematical Atlas <i data-lucide="arrow-up-right"></i></a></nav></header><nav class="news-index" aria-label="Research sections"><a href="#publications">Publications <strong>{len(publications):02}</strong></a><a href="#results">Resolved questions <strong>{len(results):02}</strong></a><span>Updated {catalog['reviewed']}</span></nav><section id="publications" class="news-section"><div class="news-section-heading"><div><p class="eyebrow">PAPERS &amp; PREPRINTS</p><h2>Publications</h2></div></div>{''.join(publications)}</section><section id="results" class="news-section"><div class="news-section-heading"><div><p class="eyebrow">FROM QUESTION TO RESULT</p><h2>Resolved questions</h2></div><a href="conjectures.html#next-questions">Where this leads next <i data-lucide="arrow-up-right"></i></a></div><div class="news-results-grid">{''.join(results)}</div></section><section class="news-onward"><h2>The next questions</h2><p>Explore the conjectures and proof targets growing from these results.</p><a href="conjectures.html#next-questions">Conjectures <i data-lucide="arrow-up-right"></i></a><a href="{BOOK}open-problems.html">Further reading in mdBook <i data-lucide="arrow-up-right"></i></a></section></main>'''
